    ...
    return (
        <div className="user-card">
            <div class="card p_3 ml-3 mb-3 bg-info text-white" style={{flex: 1, width: "200px", height: "350px", fontSize: "12px" } } >
                { !clickHandlerFound && <img class="card-img-top" style={{height: "80px", marginTop: "50px", marginBottom: "20px" }} src={userImg} alt="a user" /> }
                { clickHandlerFound && <img class="card-img-top mt-4" style={{height: "80px", marginTop: "50px", marginBottom: "20px" }} src={userImg} alt="a user" onClick={HandleClick} name={userStr} id={userObj.id} /> }
